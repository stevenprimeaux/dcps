...
Initially read all columns as text to avoid guessing about column types.
...
Observe that the 2019 file presents the data in a denormalized or "wide" format,
...
enrollment_2019 <-
  ...
  mutate(across(grade, \(x) str_squish(x))) |>
...
Pivot just the enrollment count columns back out to wide format so each
school-grade pair can be displayed on a single row.
...
school-grades that did not have at least 10 students in either year. In these
...
enrollment_yoy |>
  ...
  select(!color_fill) |>
  write_excel_csv("Deliverable 1.csv", na = "")
```
...
enrollment_yoy |>
  ...
  knitr::kable(col.names = c(
    "Grade", "Change # Students", "% Change Overall", "% Change Median",
    "# Schools", "# Increasing", "% Increasing"
  ))
```

Like you said, 9th grade saw an increase of 1,091 students (33 percent) overall 
during this period, and the median increase across schools with at least 10 
students enrolled in either year was 25 percent. 10th grade had an increase of 
268 students (10 percent), with a median increase by school of 3 percent. 16 of 
23 schools added students in 9th grade, and 12 of 22 schools added students in 
10th grade.

With 11th grade on the other hand, the small net increase of 73 students (3
percent overall) was driven primarily by adding 105 students at Coolidge. The 
median change across schools was actually a decrease of around -5 percent, and
only 9 of 21 schools added students.

12th grade showed a broad-based decline of 175 students overall (-7.1 percent),
which follows a median decline of -11 percent across schools, 15 of 20 of which
lost students over this period.
